...
def estimated(request):
    ...
    return JsonResponse({'today':todayConsumed,'month':monthConsumed,'seven':sevenConsumed,'yesterday': yesterdayConsumed,'pending':total,
                        ...
                        'area0node':area0node,'area1node':area1node,'area2node':area2node,'area1today':areapredict[0],'area2today':areapredict[1],'userconsumee':uconsume,'areac':areaConsumed,'areap':areapredict})
